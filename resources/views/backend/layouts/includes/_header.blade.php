...
<head>
  ...
  <link href="{{asset('component/assets/plugins/owl-carousel/owl.carousel.min.css')}}" rel="stylesheet">
  <link href="{{asset('component/assets/plugins/owl-carousel/owl.theme.default.min.css')}}" rel="stylesheet">
  <link href="{{asset('component/assets/plugins/magnific-popup/magnific-popup.min.css')}}" rel="stylesheet">
  <link href="{{asset('component/assets/css/app.min.css')}}" rel="stylesheet">
  <!-- Fonts/Icons -->

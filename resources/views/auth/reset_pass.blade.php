      ...
      <div class="position-middle">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-4">
            <h4 class="font-weight-light margin-bottom-30">{{__('Reset Password')}}</h4>
            <form method="POST" action="{{ route('reset.pass') }}">
              ...
              <button class="button button-lg button-outline-white-2 button-fullwidth">Reset Password</button>
            </form>
